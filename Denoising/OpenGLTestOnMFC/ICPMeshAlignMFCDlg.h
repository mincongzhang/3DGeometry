...
public:
	...
	afx_msg void OnBnClickedDenoise1();
	afx_msg void OnBnClickedDenoise2();
	afx_msg void OnBnClickedDenoise3();
	afx_msg void OnBnClickedLaplacedenoise();
	afx_msg void OnBnClickedShowpoints();
	afx_msg void OnBnClickedShowwireframe();
	afx_msg void OnBnClickedShowfaces();
	afx_msg void OnBnClickedBinormdenoise();
};
