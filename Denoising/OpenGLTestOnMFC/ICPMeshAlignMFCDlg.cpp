...
BEGIN_MESSAGE_MAP(CICPMeshAlignMFCDlg, CDialog)
	...
	ON_BN_CLICKED(Denoise1, &CICPMeshAlignMFCDlg::OnBnClickedDenoise1)
	ON_BN_CLICKED(Denoise2, &CICPMeshAlignMFCDlg::OnBnClickedDenoise2)
	ON_BN_CLICKED(LaplaceDenoise, &CICPMeshAlignMFCDlg::OnBnClickedLaplacedenoise)
	ON_BN_CLICKED(ShowPoints, &CICPMeshAlignMFCDlg::OnBnClickedShowpoints)
	ON_BN_CLICKED(ShowWireframe, &CICPMeshAlignMFCDlg::OnBnClickedShowwireframe)
	ON_BN_CLICKED(ShowFaces, &CICPMeshAlignMFCDlg::OnBnClickedShowfaces)
	ON_BN_CLICKED(Denoise3, &CICPMeshAlignMFCDlg::OnBnClickedDenoise3)
	ON_BN_CLICKED(BiNormDenoise, &CICPMeshAlignMFCDlg::OnBnClickedBinormdenoise)
END_MESSAGE_MAP()
...
void CICPMeshAlignMFCDlg::OnBnClickedDenoise1()
{
	DENOISE1_CONTROL = true;
	ALIGN_CONTROL = false;
}

void CICPMeshAlignMFCDlg::OnBnClickedDenoise2()
{
	DENOISE2_CONTROL = true;
	ALIGN_CONTROL = false;
}

void CICPMeshAlignMFCDlg::OnBnClickedDenoise3()
{
	DENOISE3_CONTROL = true;
	ALIGN_CONTROL = false;
}

void CICPMeshAlignMFCDlg::OnBnClickedLaplacedenoise()
{
...
void CICPMeshAlignMFCDlg::OnBnClickedShowpoints()
{
	SHOWPOINTS_CONTROL = true;
	SHOWWIREFRAME_CONTROL = false;
	SHOWFACES_CONTROL = false;
}


void CICPMeshAlignMFCDlg::OnBnClickedShowwireframe()
{
	SHOWWIREFRAME_CONTROL = true;
	SHOWPOINTS_CONTROL = false;
	SHOWFACES_CONTROL = false;
}


void CICPMeshAlignMFCDlg::OnBnClickedShowfaces()
{
	SHOWFACES_CONTROL = true;
	SHOWPOINTS_CONTROL = false;
	SHOWWIREFRAME_CONTROL = false;
}


void CICPMeshAlignMFCDlg::OnBnClickedBinormdenoise()
{
	BINORM_DENOISE_CONTROL = true;
}
